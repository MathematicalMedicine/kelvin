...
mv kelvin kelvin.$PLATFORM_NAME-no_GSL
...
mv kelvin kelvin.$PLATFORM_NAME-POLYUSE_DL
...
mv kelvin kelvin.$PLATFORM_NAME-POLYCODE_DL-FAKEEVALUATE
...
mv kelvin kelvin.$PLATFORM_NAME-POLYCODE_DL-FAKEEVALUATE-SSD
...
mv kelvin kelvin.$PLATFORM_NAME-POLYCHECK_DL
...
mv kelvin kelvin.$PLATFORM_NAME-POLYCOMP_DL
...
mv kelvin kelvin.$PLATFORM_NAME-POLYCOMP_DL-FAKEEVALUATE
