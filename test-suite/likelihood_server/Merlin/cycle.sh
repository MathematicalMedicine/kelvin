...
#
# $Id: cycle.sh 4531 2020-12-30 22:34:01Z whv001@CRII.ORG $
#
...
do
    ...
    perl -I$KELVIN_ROOT $KELVIN_ROOT/LKS/merlin_lk_prepare.pl server.conf
    perl -I$KELVIN_ROOT $KELVIN_ROOT/LKS/merlin_lk_server.pl server.conf
    while :
    do
	# Reveal work to be done
	FixFree=$(mysql --host=$4 --user=$6 --password=$7 $5 --batch --skip-column-names --execute="call Q('FixFree');")
