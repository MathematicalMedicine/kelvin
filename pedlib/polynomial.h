...
#define MAX_POLYNOMIAL_KEY   100000000
  ...
  #define SUM_LIST_INCREASE 100
  #define PRODUCT_LIST_INCREASE 100
  #define CONSTANT_HASH_SIZE 991
  #define VARIABLE_HASH_SIZE 97
  #define SUM_HASH_SIZE      1993
  #define PRODUCT_HASH_SIZE  1993
  #define FUNCTIONCALL_HASH_SIZE 91
#else
  #ifdef SMALLMEM
    #define CONSTANT_LIST_INCREASE 50
    #define VARIABLE_LIST_INCREASE 50
    #define SUM_LIST_INCREASE 1000
    #define PRODUCT_LIST_INCREASE 1000
    #define CONSTANT_HASH_SIZE 9991
    #define VARIABLE_HASH_SIZE 97
    #define SUM_HASH_SIZE      19993
    #define PRODUCT_HASH_SIZE  19993
    #define FUNCTIONCALL_HASH_SIZE 991
  #else
    #define CONSTANT_LIST_INCREASE 50
    #define VARIABLE_LIST_INCREASE 50
