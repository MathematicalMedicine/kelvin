...
#define CONSTANT_HASH_SIZE 99999
#define VARIABLE_HASH_SIZE 99
#define SUM_HASH_SIZE      1999999
#define PRODUCT_HASH_SIZE  1999999
#define FUNCTIONCALL_HASH_SIZE 99999
#include <stdarg.h>
...
struct sumPoly{
   ...
   //collect products
   double *factor_p;
   struct polynomial **p_p;
   int    containerLength_p;
   int    counter_p;
