...
int dadhre_(dcuhre_state *s){
  ...
  //if(s->mType == MT_DT){
    ...
    s->epsabs *= (-5.77 + 54.0* real_result + real_result*real_result)*(-5.77 + 54.0* real_result + real_result*real_result);
    ...
    printf("Setting absolute error %12.8f  diff =%f  error = %f\n", s-> epsabs,s->diff_result[s->sbrgns-1], s->error );
