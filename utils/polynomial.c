...
@file polynomial.c
 ...
 non-profit educational purposes only.
  ...
  - DMTRACK - used only with the dynamic memory tracking capabilities in
  sw.c.
  ...
  thru invocation of the compileDL.sh script on path, and the compiled
  polynomials will be loaded and used instead of their in-memory equivalents.
