...
kelvin_dcuhre_integrate (double *integral, double *abserr)
{
  ...
  fprintf (stderr, "Starting DCUHRE with dim=%d on a region of volume =%G\n", dim, volume_region);
  s->vol = volume_region;
